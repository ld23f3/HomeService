						...
						<c:if test="${pds.data!=null}">
							<c:forEach items="${pds.data}" var="order">
								<tr>
									...
									<td>未派件</td>
									<td><a href="${pageContext.request.contextPath}/CourierController?op=updispatch&orderNo=${order.ORDERNO}">修改</a></td>
								</tr>
							</c:forEach>
						</c:if>
	...
	<script>
		$(function() {
			...
			$(".pageNo")
					.click(
							function() {
								location.href = "CourierController?op=queryOrderByPage2&page="
										+ $(this).text()
										+ "&queryLike="
										+ $("#searchLike").val();
							});
			...
			$("#nextPage")
					.click(
							function() {
								...
								location.href = "CourierController?op=queryOrderByPage2&page=${pds.page + 1}"
										 +"&queryLike="
										+ $("#searchLike").val();
							});
			...
			$('#btnSearch')
					.click(
							function() {
								...
								location.href = "CourierController?op=queryOrderByPage2&queryLike="
										+ queryLike;
							});
		});
	</script>
