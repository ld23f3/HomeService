	...
	<script>
		$(function() {
			...
			$(".pageNo")
					.click(
							function() {
								location.href = "CourierController?op=queryOrderByPage0&page="
										+ $(this).text()
										+ "&queryLike="
										+ $("#searchLike").val();
							});
			...
			$("#nextPage")
					.click(
							function() {
								...
								location.href = "CourierController?op=queryOrderByPage0&page=${pds.page + 1}"
										 +"&queryLike="
										+ $("#searchLike").val();
							});
			...
			$('#btnSearch')
					.click(
							function() {
								...
								location.href = "CourierController?op=queryOrderByPage0&queryLike="
										+ queryLike;
							});
		});
	</script>
