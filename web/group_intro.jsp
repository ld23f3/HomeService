				...
				<ul id="left_menu" class="left_menu">
					...
					<li><a href="#" class="yiji"><span>团员介绍</span><em>&nbsp;</em></a>
						<ul class="erji">
							...
							<li><strong><a href="#" id="a3" onclick="btn2()">惠成</a></strong></li>
			...
			<div class="person_r">
				...
				<div id="d2" style="display: none;">
					<div class="person_rmain">
						...
						<div class="news_d">
						郑伟杰，男，外号郑狗蛋。性格娇弱，内心闷骚，学术方面暂无特长。平时喜欢打篮球（只投篮）和游泳。
对于这次项目，虽然身为组长，但是由于自身原因没能全心的投入到项目中，有点遗憾。项目起步的时候都在为数据库如何设计，业务流程如何操作头大，讨论了一天。讨论完之后各个成员分工明确，在规定时间内及时完成了项目，大家都很辛苦。当组长的这一星期，我更进一步的认识了“责任”的意义，也学会了与他人交流沟通的重要性。
				...
				<div id="d3" style="display: none;">
					<div class="person_rmain">
						...
						<div class="news_d">
						林惠成，男，我喜欢看电影，喜欢听歌，也喜欢唱歌,喜欢看一群认识的人在那打闹，然后自己在后面当一个安静的美男子。
...
在这次项目，项目分工比上次还要好，顺利了许多，希望在下一次项目，能在顺利一点。
				...
				<div  id="d6"  style="display: none;">
					<div class="person_rmain">
						...
						<div class="news_d">
						施锦明，男，这次项目总体来说，我对自己还是不满意的，还好有小伙伴的帮助，不然我头都要炸了，在这个过程中我发现有两个方面的不足：第一个方面是团队合作，我们是一个团队要及时的关注团队的最新信息，我平时一做东西就会忘了看消息，让我错过了很多信息，也容易让团队成员误以为，我不关心或不在意项目这是我的问题，要多沟通让队员知道自己的进度。第二方面，是认识到基础知识的缺乏，学习能力差。发现上课讲的东西。虽然看起来像是听会了。其实不然，你不应该只是听会，还要灵活的运用，更重要的是实践，还有老师讲的知识毕竟是少的，这个还要自己去自学一些知识，发现自己学习能力太差了。接下来要想想办法提高一些自学能力。
						</div>
					</div>
					<br/>
				</div>
				...
				<div  id="d7"  style="display: none;">
					<div class="person_rmain" >
						...
						<div class="news_d">
						婓文帅，男，这次做项目的期间，组员很照顾我，因为我请假的原因，让我负责的部分很少也都很简单，但是确实，我需要检讨自己
